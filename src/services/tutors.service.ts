...
class TutorsService {
    ...
    public async updateTutor(tutorId: number, tutorData: CreateTutorDto): Promise<Tutor> {
        ...
        await TutorEntity.update(tutorId, {name:tutorData.name, user:findUser, img_url: tutorData.img_url, profile_url : tutorData.profile_url, introduction: tutorData.introduction})
